...
import FormControl, { IFormControlProps } from '@/components/FormControl';
...
const Template: Story<IFormControlProps> = (args) => <FormControl {...args} />;
...
const TemplateWithPlacement: Story<IFormControlProps> = (args) => (
  <Column>
    <Row>
    ...
    <Row>
      <FormControl {...args} placement="left" label="左邊標題" />
    </Row>
    <Row>
      <FormControl {...args} placement="right" label="右邊標題" />
    </Row>
    <Row>
