...
const StyledInfo = styled.div<IInfo>`
  position: absolute;
  left: 50%;
  top: 50%;
 ...
 */
export const InternalProgressCircle: React.ForwardRefRenderFunction<
  HTMLDivElement,
  IProgressCircleProps
> = ({ themeColor = 'primary', value = 0, isClockwise = true, strokeColor, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <StyledInfo className="progress-circle__info" $size={size}>
...
const ProgressCircle =
  React.forwardRef<HTMLDivElement, IProgressCircleProps & extendElement<'div'>>(
